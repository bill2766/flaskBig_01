...
def get_dataloader(dataset, args):
    ...
    user_test_set = dataset(args.dataset_path, split='user_test', transforms=test_trans)
    dataloaders = {}    
    ...
    #            batch_size=args.batch_size, shuffle=False,
    #            pin_memory=args.pin_memory, num_workers=args.num_workers)
    dataloaders['user_test'] = torch.utils.data.DataLoader(user_test_set,
               batch_size=args.batch_size, shuffle=False,
               pin_memory=args.pin_memory, num_workers=args.num_workers) # args.num_workers==0
    return dataloaders
