...
def main(): 
    ...
    if not os.path.isdir(args.save_path + '/results_color_user_test'):
        os.makedirs(args.save_path + '/results_color_user_test')
    ...
    if args.predict:
        ...
        if not os.path.isdir(args.save_path + '/results_user_test'):
            os.makedirs(args.save_path + '/results_user_test')
        ...
        # 预测验证
        predict(dataloaders['user_test'], model, Dataset.mask_colors, folder=args.save_path, mode='user_test', args=args)
